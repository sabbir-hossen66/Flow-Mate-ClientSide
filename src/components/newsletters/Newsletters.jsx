...
<<<<<<< HEAD
           <div className="w-full py-3 bg-gray-500 transition-all duration-300 rounded-lg cursor-pointer filter  hover:grayscale-0" style={{backgroundImage: "url('https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/blogs/13995/images/C2GPC1ZSsqJfE7mzrmAV_4-pillars-of-teamwork.jpeg')", backgroundPosition: "center center", backgroundBlendMode: "multiply", backgroundSize: "cover"}}>
	<div className="container flex flex-col flex-wrap content-center justify-center p-4 py-20 mx-auto md:p-10">
		...
		<form onSubmit={handleSubmit(onSubmit)} className="flex flex-row">
			...
			<button type="submit" className="w-2/5 p-3 font-semibold rounded-r-lg sm:w-1/3 bg-[#191970]  text-white ">Subscribe</button>
=======

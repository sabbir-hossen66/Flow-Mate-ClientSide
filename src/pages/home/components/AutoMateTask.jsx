...
const AutoMateTask = () => {
  return (
    <div className="relative z-9 px-0 pt-[70px] pb-[120px] bg-[#1c3eef] bg-[radial-gradient(rgba(255,255,255,0)_0%,transparent_10%),radial-gradient(rgba(255,255,255,0.25)_0%,transparent_10%)] bg-[length:20px_20px] bg-[0_0,40px_40px]">
        <Container>
      ...
      <div className='flex lg:flex-row flex-col gap-5 text-white justify-between '>
        ...
        <div className='bg-[#3152f8] rounded-xl px-7 py-10'>

          ...
          <div className="flex items-center w-full max-w-3xl p-5 mx-auto lg:px-8 lg:w-[72%] ">
            <div className="w-full text">
              ...
              >
                ...
                <Button
                  type="submit"
                  className="md:col-span-2 w-full  px-6 py-3 text-sm tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-lg hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50"
                >
                  <span>Sign Up</span>
